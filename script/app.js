...
function timer() {
  if (counter < pressHoldDuration) {
    ...
    document.getElementById("beschreibung").innerHTML = '  <div> BESCHREIBUNG </div>';
    document.getElementById("feature").innerHTML = '  <div> <span>FEATURES</span> </div>';
    document.getElementById("featureText").innerHTML = '<div><span>- Gestochen scharfes Bild</span> <br><span>- 64 GB lokaler Speicherplatz</span>  <br><span>- Direkter Upload in die Cloud</span> <br><span>- Gefertigt aus Materialien der Raumfahrt</span> </div>';
